...
MIDDLEWARE = [
    ...
    # Compress dynamic responses (API JSON). WhiteNoise below only gzips
    # static files; without this the ~2.5 MB staff list pages go over the
    # wire uncompressed. GZip cuts them ~8-10x.
